...
public class BuildSym extends Tree.Visitor {
	...
	public void visitTopLevel(Tree.TopLevel program) {
		...
		for (Tree.ClassDef cd : program.classes) {
			...
			if (c.getParent() != null && c.getParent().isSealed()) {
	...
	public void visitForeach(Tree.Foreach foreach) {
		...
		Variable v = new Variable(foreach.name, foreach.type.type, 
			foreach.type.getLocation());
		table.declare(v);
		foreach.symbol = v;
