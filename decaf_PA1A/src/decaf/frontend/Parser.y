...
%token SCOPY  SEALED 	  TRIPIPE  VAR 	   REPEAT  CONCAT	IN	DEFAULT	FOREACH
...
ClassDef        :	CLASS IDENTIFIER ExtendsClause '{' FieldList '}'
				...
				|	SEALED CLASS IDENTIFIER ExtendsClause '{' FieldList '}'
					{
						$$.cdef = new Tree.ClassDef($3.ident, $4.ident, $6.flist, true, $2.loc);
					}
                ;
...
GuardedStmt 	:	IF '{' IfBranchStar IfSubStmt '}' 
			 		{
						$$.stmt = new Tree.Guarded($3.elist, $3.slist, $4.expr, $4.stmt, $1.loc);
			 		}
			 	| 	IF '{' '}'
					{
						$$.stmt = new Tree.Guarded($1.loc);
					}
				;
...
OCStmt 			:	SCOPY '(' LValue ',' Expr ')' 
		  			{
						$$.stmt = new Tree.Scopy($3.lvalue, $5.expr, $1.loc);
					}
		  		;
...
Expr            :	LValue
				...
				|	'[' Expr FOR IDENTIFIER IN Expr COMPIF ']' 
					{
						$$.expr = new Tree.Comprehension($4.ident, $6.expr, $7.expr, $2.expr, $2.loc);
					}
				|	Expr '[' Expr ']' DEFAULT Expr
					{
						$$.expr = new Tree.DefaultAccess($1.expr, $3.expr, $6.expr, $5.loc);
					}
				|	Expr '[' Expr ':' Expr ']'
					{
						$$.expr = new Tree.RangeIndexed($1.expr, $3.expr, $5.expr, $1.loc);
					}
                ;
