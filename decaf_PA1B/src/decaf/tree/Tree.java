...
public abstract class Tree {
	...
	/**
	 * Object copy statements, of type Scopy.
	 */
	public static final int SCOPY = ASSERT + 1;
	 ...
	 * Var statement.
	 */
	public static final int VARSTMT = GUARDED + 1;
	 ...
	 * Comprehension
	 */
	public static final int COMPREHENSION = ARRAYCONCAT + 1;

	/**
	 * Default access
	 */
	public static final int DEFAULTACCESS = COMPREHENSION + 1;

	/**
	 * Range index
	 */
	public static final int RANGEINDEXED = DEFAULTACCESS + 1;

	/**
	 * For each
	 */
	public static final int FOREACH = RANGEINDEXED + 1;

    /**
     * Method invocation expressions, of type Apply.
     */
    public static final int APPLY = FOREACH + 1;
	...
	public static class Scopy extends Tree {
		...
		public Scopy(LValue left, Expr expr, Location loc)  {
			super(SCOPY, loc);
			this.ident = (Ident)left;
			this.expr = expr;
		}
	...
	public static class Guarded extends Tree {
		...
		public Guarded(List<Expr> elist, List<Tree> slist, Expr expr, Tree stmt, Location loc) {
			super(GUARDED, loc);
			this.elist = elist;
			this.elist.add(0, expr);
			this.slist = slist;
			this.slist.add(0, stmt);
			empty = false;
		}
		public Guarded(Location loc) {
			super(GUARDED, loc);
			empty = true;
		}
	...
	/**
	 * A array repeat operation.
	 */
	public static class ArrayRepeat extends Expr {
		public Expr array, number;

		public ArrayRepeat(Expr array, Expr number, Location loc) {
	...
	/**
	 * A array concat operation.
	 */
	public static class ArrayConcat extends Expr {
		public Expr left, right;

		public ArrayConcat(Expr left, Expr right, Location loc) {
	...
	/**
	 * A comprehension operation.
	 */
	public static class Comprehension extends Expr {
		public Expr value, range, condition;
		public String varbind;

		public Comprehension(String varbind, Expr range, Expr condition, Expr value, Location loc) {
	...
	/**
	 * A defauly access operation.
	 */
	public static class DefaultAccess extends Expr {
		public Expr array, index, deflt;

		public DefaultAccess(Expr array, Expr index, Expr deflt, Location loc) {
			super(DEFAULTACCESS, loc);
			this.array = array;
			this.index = index;
			this.deflt = deflt;
		}
	...
	/**
	 * A range index operation.
	 */
	public static class RangeIndexed extends Expr {
		public Expr array, low, high;

		public RangeIndexed(Expr array, Expr low, Expr high, Location loc) {
			super(RANGEINDEXED, loc);
			this.array = array;
			this.low = low;
			this.high = high;
		}
	...
	public static class Foreach extends Tree {
		public TypeIdent type;
		public String name;
		public Expr range, condition;
		public Tree stmt;

		public Foreach(TypeLiteral type, String name, Expr range, Expr condition, Tree stmt, Location loc) {
			super(FOREACH, loc);
			this.type= (TypeIdent)type;
			this.name = name;
			this.range = range;
			this.condition = condition;
			this.stmt = stmt;
    ...
    public static abstract class Visitor {
		...
		public void visitDefaultAccess(DefaultAccess that) {
			visitTree(that);
		}

		public void visitRangeIndexed(RangeIndexed that) {
			visitTree(that);
		}
